...
public class TreinoConfiguration : IEntityTypeConfiguration<Treino>
{
    public void Configure(EntityTypeBuilder<Treino> builder)
    {
        ...
        builder.Property(e => e.DataInicioVigencia).HasColumnName("data_inicio_vigencia").HasColumnType("TIMESTAMP").IsRequired();
        builder.Property(e => e.DataFimVigencia).HasColumnName("data_fim_vigencia").HasColumnType("TIMESTAMP").IsRequired();
        ...
        //relacionamentos fk na tabela GrupoTreino
        builder.HasMany(e => e.GruposTreinos).WithOne(t => t.Treino).HasForeignKey(e => e.TreinoId);
    }
}
