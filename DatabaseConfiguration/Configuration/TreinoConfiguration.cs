...
public class TreinoConfiguration : IEntityTypeConfiguration<Treino>
{
    public void Configure(EntityTypeBuilder<Treino> builder)
    {
        ...
        builder.Property(e => e.EdFisicoId).HasColumnName("ed_fisico_id")
                                           .HasColumnType("int")
                                           .IsRequired();
        ...
        builder.Property(e => e.DataInicioVigencia).HasColumnName("data_inicio_vigencia")
                                                   .HasColumnType("DATE")
                                                   .ValueGeneratedOnAdd()
                                                   .HasDefaultValueSql("now()");

        builder.Property(e => e.DataFimVigencia).HasColumnName("data_fim_vigencia")
                                                .HasColumnType("DATE");
        ...
        builder.HasOne(e => e.EdFisico)
               .WithMany(t => t.Treinos )
               .HasForeignKey(t => t.EdFisicoId);
        ...
        builder.HasMany(e => e.ItensTreinoARealizar)
               .WithOne(t => t.Treino)
