...
public class FeedbackConfiguration : IEntityTypeConfiguration<Feedback>
{
    public void Configure(EntityTypeBuilder<Feedback> builder)
    {
        ...
        builder.Property(f => f.Mensagem).HasColumnName("mensagem")
                                         .HasColumnType("varchar(255)")
                                         .IsRequired();

        builder.Property(f => f.Direcao).HasConversion<int>()
                                        .HasColumnName("direcao")
                                        .HasColumnType("int").IsRequired();

        builder.Property(f => f.AlunoId).HasColumnName("aluno_id")
                                        .HasColumnType("int")
                                        .IsRequired();

        builder.Property(f => f.EdFisicoId).HasColumnName("ed_fisico_id")
                                           .HasColumnType("int")
                                           .IsRequired();
        ...
        builder.HasOne(f => f.EdFisico)
               .WithMany(e => e.Feedbacks)
               .HasForeignKey(f => f.EdFisicoId);
